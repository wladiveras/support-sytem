...
<div id="app-cookie-bar" class="d-none cookie-bar animated <?php echo $gdpr_animation; ?>" style="color:<?php echo $text_color; ?>;background: rgba(<?php echo $r ?>,<?php echo $g ?>,<?php echo $b ?>,<?php echo $gdpr_op; ?>); ">
	<div class="container">
        <div class="row">
        ...
        <div class="col-md-2 col-sm-4 acpt-container">
            <a href="" id="cookie_a_btn" class="acpt-btn btn btn-outline-secondary btn-block"><?php _e("Accept") ; ?></a>
        </div>
        </div>
    </div>
</div>
