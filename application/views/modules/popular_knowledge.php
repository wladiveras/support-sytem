...
<div class="panel panel-default app-panel-box">
			<div class="panel-heading"><?php _e("%s Popular Knowledge",$ctg_title); ?></div>		  
		  ...
		  <ul class="kn-list ctg-list">
		      	...
		      	foreach ($_tkts as $_tkt){
		      	    ...
		      	    <a href="<?php echo site_url("knowledge/details/{$_tkt->id}/{$_tkt->slug_id}");?>">
		      	     ...
		      	     if($isViewCount){
		      	     ?>
		      	     <span class="pull-right">( <i class="fa fa-eye"></i> <?php echo _n(str_pad($_tkt->v_count, 2,'0',STR_PAD_LEFT));?> )</span>
                     <?php } ?>
		      	    </a>    				
		      	    </h5>		      	    
		      	    </li>
